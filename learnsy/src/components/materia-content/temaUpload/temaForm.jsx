                ...
                {modalStep === "form" && (
                    <>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label htmlFor="nombre" className="block body text-sm font-semibold mb-2">
                            ...
                            <div>
                                <label htmlFor="archivo" className="block body text-sm font-semibold mb-2">
                                    Archivo PDF:
                                </label>
                                <input
                                    type="file"
                            ...
                            <div className="flex gap-20 pt-2 justify-center">
                                ...
                                <button
                                    ...
                                    className="cursor-pointer w-60 flex items-center justify-center gap-2 bg-[#C65CB1] 
                                           text-white py-2 px-8 rounded-md btn-primary disabled:cursor-not-allowed"
                                >
                                    {loading ? (
                                        <>
